<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Fight.aspx.vb" Inherits="WarCardGame.Fight" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <div class="jumbotron">
        ...
        <asp:Button ID="btnStart" runat="server" Text="Start Game" />
          &nbsp;<asp:Button ID="btnStartOver" runat="server" Text="StartOver" />
